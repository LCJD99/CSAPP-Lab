0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x9,%rsp
...
0000000000400efc <phase_2>:
  ...
  400f1a:	01 c0                	add    %eax,%eax "caculate ? "
                              if:
  400f1c:	39 03                	cmp    %eax,(%rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f25:	48 83 c3 04          	add    $0x4,%rbx
                                if:
    400f29:	48 39 eb             	cmp    %rbp,%rbx  "rbp stop"
...
0000000000400f43 <phase_3>:
  ...
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt>
                              ...
                              return :
400f60:	83 f8 01             	if:     %eax <=  1
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
                              else:
  400f6a:	83 7c 24 08 07       	cmpl   0x8(%rsp) > 7 
                                "GG"
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>

  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) "next_line + %rax * <2 line>"
...
0000000000400fce <func4>:
  ...
  400fd6:	89 c1                	mov    %eax,%ecx  %ecx = 0xe %eax = 0xe, 
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx >> 16
  400fdb:	01 c8                	add    %ecx,%eax += (? 0)
...
000000000040131b <string_length>:
  ...
  401323:	48 83 c2 01          	add    $0x1,%rdx  "the point add 1"
  401327:	89 d0                	mov    %edx,%eax	"eax store the edx()"
  401329:	29 f8                	sub    %edi,%eax
  40133b:	80 3a 00             	cmpb   $0x0,(%rdx)
...
0000000000401338 <strings_not_equal>:
  ...
  401361:	74 25                	je     401388 <strings_not_equal+0x50> "great"
